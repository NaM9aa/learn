...
var geojs = {
    ...
    intersectWithTriangle: function (lx1, ly1, lx2, ly2, tx1, ty1, tx2, ty2, tx3, ty3) {
        ...
        var messB = null;
        var messC = null;
        geojs.intersect(tx1, ty1, tx2, ty2, lx1, ly1, lx2, ly2);
        
        if (this.intersect.x != null && this.intersect.y != null) {
            c = this.intersect.x + ' , ' + this.intersect.y;
            }
            else{c = '';}

            this.intersect(tx2, ty2, tx3, ty3, lx1, ly1, lx2, ly2);
        
        if (this.intersect.x != null && this.intersect.y != null) {
            a = this.intersect.x + ' , ' + this.intersect.y;
            }
            else{a = '';}

            this.intersect(tx1, ty1, tx3, ty3, lx1, ly1, lx2, ly2);
        
        if (this.intersect.x != null && this.intersect.y != null) {
            b = this.intersect.x + ' , ' + this.intersect.y;
            }
            else{b = '';}
