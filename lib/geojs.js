...
var geojs = {
    ...
    intersectWith2Rectangles: function (x1, y1, w1, l1, x3, y3, w2, l2) {
        ...
        if (a == "" && b == "" && c == "" && d == "") {
            ...
            if(c1 == "" && c2 == "" && c3 == "" && c4 == "") { mess = "none"; }*/
            //
            var xs = [x1, x2, x1, x2];
            var ys = [y1, y1, y2, y2];
            var c1234 = [];
            for (var i = 0; i < 4; i++) {
                if ((xs[i] == x3 && ys[i] == y3) || (xs[i] == x4 && ys[i] == y3) || (xs[i] == x3 && ys[i] == y4) || (xs[i] == x4 && ys[i] == y4)) {
                    c1234.push(xs[i] + "," + ys[i] + "  ");
                }
            }
            if (c1234.length == 0) { mess = "none"; }
    ...
    AirIntersect2Rect: function (x1, y1, w1, l1, x3, y3, w2, l2) {
        function intersectWith2Rectangles(x1, y1, w1, l1, x3, y3, w2, l2) {
        ...
        var result = intersectWith2Rectangles(x1, y1, w1, l1, x3, y3, w2, l2);
        var xs = result.xs;
        var ys = result.ys;
        if (x1 >= x3 && x1 <= x4) {
            if (y1 >= y3 && y1 <= y4 && (x1 != x3 || y1 != y3) && (x1 != x3 || y1 != y4) && (x1 != x4 || y1 != y3) && (x1 != x4 || y1 != y4)) {
                xs.push(x1);
                ys.push(y1);
            }
            if (y2 >= y3 && y2 <= y4 && (x1 != x3 || y2 != y3) && (x1 != x3 || y2 != y4) && (x1 != x4 || y2 != y3) && (x1 != x4 || y2 != y4)) {
                xs.push(x1);
                ys.push(y2);
            }
        }
        if (x2 >= x3 && x2 <= x4) {
            if (y1 >= y3 && y1 <= y4 && (x2 != x3 || y1 != y3) && (x2 != x3 || y1 != y4) && (x2 != x4 || y1 != y3) && (x2 != x4 || y1 != y4)) {
                xs.push(x2);
                ys.push(y1);
            }
            if (y2 >= y3 && y2 <= y4 && (x2 != x3 || y2 != y3) && (x2 != x3 || y2 != y4) && (x2 != x4 || y2 != y3) && (x2 != x4 || y2 != y4)) {
                xs.push(x2);
                ys.push(y2);
            }
        }
